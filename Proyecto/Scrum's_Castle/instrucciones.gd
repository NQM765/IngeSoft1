...
var full_text = "En este juego tendrás que gestionar un equipo de personas con diferentes habilidades.
Se te asignarán un conjunto de tareas que debes completar en -- minutos. Sé estratégico al definir el integrante que realizará cada tarea.
